...
//*****************************************************************************//
//************************     alg_1    ***************************************//
//***************   use default AES algorithm to encrypt & decrypt  ***********//
//*****************************************************************************//
...
//*****************************************************************************//
//************************     alg_2    ***************************************//
//******  use default DES algorithm to encrypt & decrypt , with DES could *****//
//******   only deal 64 bit , do DES twice while deal with 128 bit .      *****//
//*****************************************************************************//
...
//*****************************************************************************//
//************************     alg_3    ***************************************//
//*****   use default 3DES algorithm to encrypt & decrypt , with DES could ****//
//*****   only deal 64 bit , do 3DES twice while deal with 128 bit .      *****//
//*****************************************************************************//
...
//*****************************************************************************//
//************************     alg_4    ***************************************//
//******       try to combine different algorithms together        ************//
//*****************************************************************************//
...
static void enc_default (struct crypto_tfm *tfm , u8 *out, const u8 *in)
{
	...
	hex_print (ctx->key , "def_enc is working with " , 32) ;
...
static void dec_default (struct crypto_tfm *tfm , u8 *out, const u8 *in)
{
	...
	hex_print (ctx->key , "def_dec is working with " , 32) ;
